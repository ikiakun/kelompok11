...
<head>
    ...
    <title>Perpustakaan | Daftar Petugas</title>
            ...
            <div class="row mt-3">
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control w-50" placeholder="Masukkan Nama petugas..." required>
                    </div>
                    <div class="mb-3">
    ...
    <?php
        ...
        $password2 = $_POST['konfirmasi'];
            ...
            if($password == $password2){
                $query = mysqli_query ($db, "INSERT INTO petugas VALUES ('', '$nama', '$kelamin', '$alamat', '$password', 2)");

                if($query){
                    echo "<script>alert('Berhasil Menambahkan Data Petugas');
                        window.location='daftar-petugas.php';</script>";
                }else{
                    echo "<script>alert('Gagal Menambahkan Data Petugas')</script>";
                }
