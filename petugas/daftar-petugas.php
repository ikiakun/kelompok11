...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <a href="input-petugas.php" class="btn btn-primary"><i class="fa-solid fa-user-plus"></i> Tambah Data Petugas</a>
            <div class="row mt-3">
                <table class="table text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $data['alamat'] ?></td>
                            <td><a href="edit-petugas.php?id=<?= $data['nip'] ?>" class="btn btn-warning">Edit</a></td>
                            <td>
                                <form action="" method="GET">
                                    <input type="hidden" value="<?= $data['nip'] ?>" id="nip" name="nip" hidden> 
